...
export default function Reports() {
  return (
    <div className="min-h-screen w-screen px-4 md:px-6 lg:px-8">
      <div className="mx-auto py-3 relative">
        {/* HEADER */}
        <div className="flex flex-col md:flex-row md:items-center gap-5  sticky md:w-full  top-0 bg-gray-50 z-10">
          <h1 className="text-2xl font-semibold text-gray-900">My Reports</h1>

          <div className="items-center bg-gray-300 px-1 py-1 rounded-md flex">
            <div className="flex items-center justify-between md:justify-normal md:grid gap-4  lg:grid-cols-4">
              <NavLink
                className="justify-center transition-all duration-300 ease-in-out px-1 py-2 rounded-md "
                variant="outline"
                to="/reports"
                style={({ isActive }) => {
...
//         <div className="bg-white flex justify-center items-center py-3 px-2  rounded-lg shadow ">
//           <div>
...
//         <div className="bg-white py-3 px-2  rounded-lg shadow md:col-start-1 md:col-end-2 ">
...
//         <div className="bg-white py-3 px-2  rounded-lg shadow lg:col-span-4 ">
//           {/* <BarChart className="w-full h-[300px]" /> */}
//           <div className="flex justify-between items-center mt-3 ">
